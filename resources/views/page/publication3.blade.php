...
@section('content')
    ...
    <div class="w-full bg-gray-400 px-16 py-28 bg-cover bg-blend-multiply bg-center "
        ...
        <div class="text-center text-white">
            <h1 class=" font-bold text-3xl lg:text-4xl">Publication</h1>
            <div class="flex justify-center items-center pt-2">
                ...
                <h1 class="text-base lg:text-md ">Home / Publication</h1>
            </div>
    ...
    <!-- Artikel Start -->
    <div class="bg-white lg:px-20 lg:mx-12 mx-8 mb-4  lg:mb-16 md:px-4">
