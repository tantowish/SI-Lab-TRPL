...
@section('content')
    <div class="w-full  bg-gray-400 px-16 py-28 bg-cover bg-blend-multiply bg-center"
        ...
        <div class="text-center text-white">
            <h1 class="text-2xl font-bold sm:text-3xl lg:text-5xl">Membership</h1>
    ...
    <div class=" py-12 md:px-12 lg:px-40 px-8 lg:py-24   w-full">
        <div class="flex lg:flex-row md:flex-row flex-col  justify-between gap-4">
            <img src="{{ asset('assets/img/page/membership1/image 28.png') }}" class="px-6 lg:px-0 lg:w-[350px] bg-cover"
                alt="Proyek Image">
            <div class="flex flex-col  py-2 lg:pr-12  md:pr-4  justify-center">
                <div class="font-bold text-lg lg:text-2xl flex text-left">Dr. Maritza Angel, S.T., M.Eng.
                </div>
                <div class="text-md lg:text-xl py-2 flex  text-left">
                    COMPUTER SCIENCE/ MACHINE LEARNING/ DATA AND SOFTWARE ENGINERING
                </div>
                <div class="pt-2 md:pt-12  lg:pt-12 text-left">
                    <div class="text-sm lg:text-xl">210198102201909101</div>
                    <div class="text-sm lg:text-xl">
                        Email : maritzaangelinaazzahra@mail.ugm.ac.id
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="text-sm lg:text-lg text-justify">
            ...
            perferendis pariatur ea qui omnis, deleniti at non exercitationem
            debitis sunt fugit sequi, sapiente et! Quidem assumenda ipsum asperiores
            obcaecati ad.
        </div>
